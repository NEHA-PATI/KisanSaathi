...
export default function TraceabilityPage({
  ...
  const scrollToDemo = () => {
    document
      .getElementById("ta-video-section")
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      document.getElementById("root")?.classList.remove("traceability-root-active");
    };
  }, [embedded]);
        ...
        <div className="ta-container ta-hero-inner">
          <div className="ta-hero-content">
            ...
            <p className="ta-hero-desc">
              A unified platform to track every stage of agricultural production.
              Monitor crop health, field activity, harvest readiness, and supply
              chain movement with total transparency.
            </p>
            <div className={`ta-hero-btns${centerDashboardButton ? " dashboard-only" : ""}`}>
              {!centerDashboardButton &&
                (onStartMonitoring ? (
                  ...
                  <Link className="ta-btn-black ta-btn-lg ta-btn-link" to="/traceconnect">
                    Start Monitoring <ArrowRight size={18} />
                  </Link>
                ))}
              {onGoToDashboard ? (
                <button className="ta-btn-outline ta-btn-lg" type="button" onClick={onGoToDashboard}>
                  Go to Dashboard
                </button>
              ) : (
                <button className="ta-btn-outline ta-btn-lg" type="button" onClick={scrollToDemo}>
                  Show a Demo
                </button>
              )}
            </div>
            ...
            <div className="ta-dashboard-card">
              <div className="ta-card-header">
                <div>
                  ...
                  <p className="ta-card-subtitle">Batch: #AG-7429 - Premium Wheat</p>
                </div>
      ...
      <section className="ta-video-section" id="ta-video-section">
        <div className="ta-container ta-video-inner">
          ...
          <p className="ta-section-desc">
            Watch how the platform transforms agricultural data into actionable insights.
          </p>
          <div className="ta-video-player">
            ...
            <div className="ta-video-brand-overlay">
              <span className="ta-video-brand-text">MaatiAI</span>
            </div>
          </div>
          <a
